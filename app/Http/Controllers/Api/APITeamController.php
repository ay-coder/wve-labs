...
class APITeamController extends BaseApiController
{
    ...
    public function index(Request $request)
    {
        ...
        {
            $itemsOutput = $this->teamTransformer->transformCollection($items);
    ...
    public function create(Request $request)
    {
        ...
        if($model)
        {
            $responseData = $this->teamTransformer->transform($model);

            return $this->successResponse($responseData, 'Team is Created Successfully');
        }
    ...
    public function show(Request $request)
    {
        ...
        if($itemId)
        {
            ...
            if($itemData)
            {
                $responseData = $this->teamTransformer->transform($itemData);
    ...
    public function edit(Request $request)
    {
        ...
        if($itemId)
        {
            ...
            if($status)
            {
                ...
                return $this->successResponse($responseData, 'Team is Edited Successfully');
            }
        }
